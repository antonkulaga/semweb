...
import org.denigma.semweb.rdf.vocabulary.{RDFS, RDF, WI}
import org.denigma.semweb.rdf.{Quad, Res, Trip, _}
...
case class SubjectRule(id:Label ,
...
case class ContextRule(id:Label,value:ValueClass, title:Option[String] = None) extends FieldRule(id,value,title)
{

...
object SimpleRead {
  ...
  case class Select(query:String,offset:Int = 0, limit:Int = Int.MaxValue,rewrite:Boolean = false) extends Paginated with SimpleQuery

  case class Bind(query:String,binds:Map[String,String],offset:Int = 0, limit:Int = Int.MaxValue) extends Paginated  with SimpleQuery

  case class Search(query:String,searches:Map[String,String],binds:Map[String,String] = Map.empty,offset:Int = 0, limit:Int = Int.MaxValue,params:Map[String,String]) extends Paginated with SimpleQuery
